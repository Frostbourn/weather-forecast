    ...
    <>
      <div class="w-64 cursor-pointer border b-gray-400 rounded flex flex-col justify-center my-100 mx-auto items-center text-center p-6 bg-white">
        <div class="text-md font-bold flex flex-col text-gray-900">
          <span class="uppercase">{query}</span> <span>dzisiaj</span>{" "}
        ...
        <div class="text-3xl font-bold text-gray-900 mb-6">
          {maxTemp ? maxTemp + "º" : "Wczytuję..."}
          <span class="font-normal text-gray-700 mx-1">/</span>
          {minTemp ? minTemp + "º" : "Wczytuję..."}
        </div>
        <div class="flex justify-between w-full">
          <div class="flex items-center text-gray-700 px-2">
            ...
            {rain ? rain + "mm" : rain > 0 ? "Wczytuję..." : 0} l/m<sup>2</sup>
          </div>
          <div class="flex items-center text-gray-700 px-2">
            <svg
              class="mr-2 h-4 w-4"
