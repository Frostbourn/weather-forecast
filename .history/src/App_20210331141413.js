...
const App = () => {
  ...
  return (
    <>
      <div class="grid grid-rows-3 grid-flow-col gap-4 max-w-md bg-white px-8 py-6 rounded-xl space-y-5 items-center my-100 mx-auto">
        <div class="row-span-3">
          <SearchBox className="w-64" state={handleChange} />
