...
const App = () => {
  ...
  let thirdDay = addDays(new Date(), 3);
  let fourthDay = addDays(new Date(), 4);
  let fifthDay = addDays(new Date(), 5);
  let sixthDay = addDays(new Date(), 6);
  let seventhDay = addDays(new Date(), 7);
